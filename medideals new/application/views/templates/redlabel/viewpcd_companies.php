	...
	<section class="content inner-pg shop-pg shop-product-pg clearfix">
		...
		<div class="product-items-detail clearfix">
			...
			<div class="col-sm-12 col-md-6 col-lg-6 padding">
				<div class="left-side">
					<a class="image fancybox" data-fancybox-group="gallery" href="images/shop-product-img.jpg"><img alt="IMAGE" class="img-responsive" src="<?= base_url('upload_pic/' . $viewpcd_companies['pcd_image']) ?>"></a>
				</div>
			</div>
			<div class="col-sm-12 col-md-6 col-lg-6 padding">
				<div class="right-side">
					<h4><?= $viewpcd_companies['pcd_name'] ?></h4>
							
					<div class="product-categories">
					<span> Company Name:</span> <?= $viewpcd_companies['pcd_name']  ?>
					<br/>
					<br/>
					<span> Company Address: </span> <?= $viewpcd_companies['pcd_address']  ?>
						<br/>
						<br/>
						<span>Company Phone Number: </span>  <?= $viewpcd_companies['pcd_phone']  ?>
						<br/>
						<br/>
						<span>State: </span>  <?= $viewpcd_companies['state']  ?>
						<br/>
						<br/>
						<span>City: </span>  <?= $viewpcd_companies['name']  ?>
						<br/>
						<br/>
						...
						<div class="bs-example bs-example-tabs" data-example-id="togglable-tabs" role="tabpanel">
							...
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade in active" id="description" role="tabpanel">
									...
									<?= $viewpcd_companies['pcd_description'] ?>
								</div><!--/.tab-pane-->
							</div><!--/.tab-content-->
						</div><!--/.bs-example-->
					</div><!-- Description End -->
