...
<form method="POST" action="" enctype="multipart/form-data">
    ...
    <div class="form-group for-shop">
        ...
        <input type="text" placeholder="number" name="minquantity" value="<?= @$_POST['minquantity'] ?>" class="form-control" id="quantity">
    </div>
    <?php if ($showBrands == 1) { ?>
        <div class="form-group for-shop">
            <label>Company</label>
    ...
    <!--<div class="form-group for-shop">
        ...
        <input type="text" placeholder="Position number" name="position" value="" class="form-control">
    </div>
    <div class="form-group for-shop">
