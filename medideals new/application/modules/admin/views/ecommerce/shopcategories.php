            ...
            <table class="table table-striped custab">
                ...
                foreach ($shop_categories as $key_cat => $shop_categorie) {
                    ...
                    foreach ($shop_categorie['info'] as $ff) {
                        $catName .= '<div>'
                                . '<a style="color:#000 !important" href="javascript:void(0);" class="editCategorie" data-indic="' . $i . '" data-for-id="' . $key_cat . '" data-abbr="' . $ff['abbr'] . '" data-toggle="tooltip" data-placement="top" title="Edit this categorie">'
                    ...
                    <tr>
                        ...
                        <td><?= $catName ?></td>
                        <td> 
                            <a style="color:#000 !important" href="javascript:void(0);" class="editCategorieSub" data-sub-for-id="<?= $key_cat ?>">
                                <i class="fa fa-pencil" aria-hidden="true"></i>
                            </a>
                        ...
                        <td>
                            <a style="color:#000 !important" href="javascript:void(0);" class="editPosition" data-position-for-id="<?= $key_cat ?>" data-my-position="<?= $shop_categorie['position'] ?>">
                                <i class="fa fa-pencil" aria-hidden="true"></i>
                            </a>
