<div id="products">
    ...
    ?>
    <h1><img src="<?= base_url('assets/imgs/products-img.png') ?>" class="header-img" alt="product Image" style="margin-top:-2px;"> Products</h1>
    <hr>
    <div class="row">
        <div class="col-xs-12">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($products as $row) {
                                ...
                                <tr>
                                    <td>
                                        <img src="<?= $image ?>" alt="No Image" class="img-thumbnail" style="width:100px !important;">
                                    </td>
                                    <td><?= $row->title ?></td>
                                    <td><?= $row->price ?></td>
									<td><?= $row->old_price ?></td>
                                    ...
                                    <td><?= $row->vendor_id > 0 ? '<a style="color:#000;" href="?show_vendor=' . $row->vendor_id . '">' . $row->vendor_name . '</a>' : 'No vendor' ?></td>
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <a href="<?= base_url('admin/publish/' . $row->id) ?>" class="btn btn-info" style="margin-bottom: 5px">Edit</a>
                                            <br/>
